...
// all blocks' seal as valid, though they still have to conform to the coqchain
// consensus rules.
...
// still have to conform to the coqchain consensus rules.
...
// they still have to conform to the coqchain consensus rules.
