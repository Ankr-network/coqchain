...
func TestBlockEncoding(t *testing.T) {
	...
	tx1 := NewTransaction(CoqTx, common.Hash{}, 0, common.HexToAddress("095e7baea6a6c7c4c2dfeb977efac326af552d87"), big.NewInt(10), 50000, big.NewInt(10), nil)
...
func makeBenchBlock() *Block {
	...
	for i := range txs {
		...
		data := make([]byte, 100)
		tx := NewTransaction(CoqTx, common.Hash{}, uint64(i), common.Address{}, amount, 123457, price, data)
