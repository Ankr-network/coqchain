...
func testRepair(t *testing.T, tt *rewindTest, snapshots bool) {
	...
	if tt.sidechainBlocks > 0 {
		sideblocks, _ = GenerateChain(params.AllEthashProtocolChanges, genesis, engine, rawdb.NewMemoryDatabase(), tt.sidechainBlocks, func(i int, b *BlockGen) {
	...
	canonblocks, _ := GenerateChain(params.AllEthashProtocolChanges, genesis, engine, rawdb.NewMemoryDatabase(), tt.canonicalBlocks, func(i int, b *BlockGen) {
...
// TestIssue23496 tests scenario described in https://github.com/Ankr-network/coqchain/pull/23496#issuecomment-926393893
...
func TestIssue23496(t *testing.T) {
	...
	blocks, _ := GenerateChain(params.AllEthashProtocolChanges, genesis, engine, rawdb.NewMemoryDatabase(), 4, func(i int, b *BlockGen) {
		b.SetCoinbase(common.Address{0x02})
		b.SetDifficulty(big.NewInt(1000000))
	})
