...
// Package state provides a caching layer atop the coqchain state trie.
package state
...
// StateDB structs within the coqchain protocol are used to store anything
...
func (s *StateDB) Copy() *StateDB {
	...
	for addr := range s.journal.dirties {
		// As documented [here](https://github.com/Ankr-network/coqchain/pull/16485#issuecomment-380438527),
