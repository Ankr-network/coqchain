...
// Trie is a coqchain Merkle Patricia trie.
type Trie interface {
...
func NewDatabase(db ethdb.StateStore) Database {
...
// large memory cache.
func NewDatabaseWithConfig(db ethdb.StateStore, config *trie.Config) Database {
