...
var (
	walletCommand = cli.Command{
		Name:      "wallet",
		Usage:     "Manage coqchain presale wallets",
		ArgsUsage: "",
		...
		Subcommands: []cli.Command{
			{
				...
				Name:      "import",
				Usage:     "Import coqchain presale wallet",
				ArgsUsage: "<keyFile>",
...
between coqchain nodes by simply copying.
...
Note:
As you can directly copy your encrypted accounts to another coqchain instance,
