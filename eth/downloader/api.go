...
// Syncing provides information when this nodes starts synchronising with the coqchain network and when it's finished.
...
type SyncingResult struct {
	...
	Status  coqchain.SyncProgress `json:"status"`
}
