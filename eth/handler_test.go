...
var (
	...
	// testAddr is the coqchain address of the tester account.
...
// testHandler is a live implementation of the coqchain protocol handler, just
...
func newTestHandlerWithBlocks(blocks int) *testHandler {
	...
	chain, _ := core.NewBlockChain(db, nil, params.AllEthashProtocolChanges, ethash.NewFaker(), vm.Config{}, nil, nil)

	bs, _ := core.GenerateChain(params.AllEthashProtocolChanges, chain.Genesis(), ethash.NewFaker(), db, blocks, nil)
