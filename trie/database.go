...
type Database struct {
	diskdb ethdb.StateStore // Persistent storage for matured trie nodes
...
func NewDatabaseWithConfig(diskdb ethdb.StateStore, config *Config) *Database {
...
func (db *Database) DiskDB() ethdb.StateStore {
	return db.diskdb
}
