...
const schema string = `
    ...
    scalar Bytes32
    # Address is a 20 byte coqchain address, represented as 0x-prefixed hexadecimal.
    scalar Address
    ...
    # Account is an coqchain account at a particular block.
    type Account {
    ...
    # Transaction is an coqchain transaction.
    type Transaction {
    ...
    type Block {
        ...
        # Account fetches an coqchain account at the current block's state.
    ...
    type Pending {
      ...
      transactions: [Transaction!]
      # Account fetches an coqchain account for the pending state.
      account(address: Address!): Account!
    ...
    type Query {
        # Block fetches an coqchain block by number or by hash. If neither is
