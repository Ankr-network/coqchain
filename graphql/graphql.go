...
// Account represents an coqchain account at a particular block.
type Account struct {
...
// Transaction represents an coqchain transaction.
...
// Block represents an coqchain block.
...
type CallData struct {
	From                 *common.Address // The coqchain address the call is from.
	To                   *common.Address // The coqchain address the call is to.
...
type SyncState struct {
	progress coqchain.SyncProgress
}
