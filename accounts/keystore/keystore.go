...
// See https://github.com/coqchain/wiki/wiki/Web3-Secret-Storage-Definition for more information.
package keystore
...
// ImportPreSaleKey decrypts the given coqchain presale wallet and stores
