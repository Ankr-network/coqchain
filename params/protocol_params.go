...
const (
	...
	BaseFeeChangeDenominator = 0 // Bounds the amount the base fee can change between blocks.
	ElasticityMultiplier     = 0 // Bounds the maximum gas limit an EIP-1559 block may have.
