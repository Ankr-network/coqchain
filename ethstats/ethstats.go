...
import (
	...
	ethproto "github.com/Ankr-network/coqchain/eth/protocols/eth"
...
type backend interface {
	...
	SyncProgress() coqchain.SyncProgress
}
...
// Service implements an coqchain netstats reporting daemon that pushes local
